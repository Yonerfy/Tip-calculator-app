...
<template>
    <div class="input-form mt-[2.5em] mb-[3em] md:mb-0">
        ...
        <div class="people-container flex items-center relative mt-2">
            ...
            <input :value="modelValue" @input="$emit('update:modelValue',$event.target.value)" type="number" id="people" placeholder="0" class="w-[23.688em] text-right bg-[#F3F9FA] p-[.5em] rounded-md text-[#00474B]
            text-preset-3"  />
        </div> 
    </div>
</template>
